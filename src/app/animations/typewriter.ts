...
export default class Typewriter{
  ...
  /**
   *
   * @param parent elemento aonde vai ter o texto
   * @param param1 opções loop: boolean, typingSpeed: number, deletingSpeed: number, color: #000
   */
  constructor(
    parent: HTMLElement,
    { loop = false, typingSpeed = 50, deletingSpeed = 50, color = '#000' } = {}
    ) {
